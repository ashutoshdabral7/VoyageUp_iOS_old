...
#define KEYBOARD_HEIGHT 140 //deepak
...
#pragma clang diagnostic pop
        ...
        // Font
//        _titleFontFamily = @"NeoSans-Bold";
//        _bodyTextFontFamily = @"OpenSans";
//        _buttonsFontFamily = @"NeoSans-Bold";
       
        _titleFontFamily = @"Montserrat-Bold";
        _bodyTextFontFamily = @"Montserrat-Light";
        _buttonsFontFamily = @"Montserrat-Regular";
        
        _titleFontSize = 17.0f;
        _bodyFontSize = 14.0f;
...
- (void)viewWillLayoutSubviews
{
    ...
    if(!_usingNewWindow)
    {
        ...
        {
            // View is showing, position at center of screen  //deepak
...
-(SCLAlertViewResponder *)showTitle:(UIViewController *)vc image:(UIImage *)image color:(UIColor *)color title:(NSString *)title subTitle:(NSString *)subTitle duration:(NSTimeInterval)duration completeText:(NSString *)completeText style:(SCLAlertViewStyle)style
{
    ...
    switch (style)
    {
        ...
        case Notice:
            viewColor = UIColorFromHEX(0x0070a2);
        ...
        case Edit:
            viewColor =COLOR_TEXT;// UIColorFromHEX(0x0070a2);
...
#pragma clang diagnostic pop
    ...
    for (SCLButton *btn in _buttons)
    {
        ...
        NSString *tit = [btn titleForState:UIControlStateNormal];
       
        
        if([tit isEqualToString:BUTTON_WILL_WAIT]){
            
            btn.backgroundColor = [UIColor whiteColor];
            
            [btn setTitleColor:[UIColor colorWithRed:0.0/255.0 green:112.0/255.0 blue:162.0/255.0 alpha:1.0] forState:UIControlStateNormal];
            
            
            
        }else if (btn.completeButtonFormatBlock != nil)
        {
...
{
    [self showTitle:vc image:nil color:COLOR_TEXT title:title subTitle:subTitle duration:duration completeText:closeButtonTitle style:Edit];
}
...
- (void)showCustom:(UIViewController *)vc image:(UIImage *)image color:(UIColor *)color title:(NSString *)title subTitle:(NSString *)subTitle closeButtonTitle:(NSString *)closeButtonTitle duration:(NSTimeInterval)duration
{
    ...
    NSLog(@"_circleIconHeight=  %f",_circleIconHeight);
}
